...
public enum Plugins {
	...
	fb_contrib("fb-contrib-7.7.4.jar", "com.mebigfatguy.fbcontrib", true,
					"fb-contrib-7.6.9.jar", "fb-contrib-7.6.0.jar",
	...
	findsecbugs_plugin("findsecbugs-plugin-1.14.0.jar","com.h3xstream.findsecbugs", true,
			"findsecbugs-plugin-1.13.0.jar", "findsecbugs-plugin-1.12.0.jar",
